...
public class MovieFilterer {
    //Todo: Please take a look at builder pattern. I suggest using it for this filterer class to add any kinds of filter combinations and return fully filtered list later
